...
export default function SignDesigner() {
  ...
  const ratio = useMemo(
    () => Math.min(6, Math.max(1.2, width / Math.max(height, 1))),
    [width, height]
  );
      ...
      <div className="designer-layout">
        <aside className="designer-panel">
          <div className="designer-panel-heading">
            ...
            <span>
              Zemin, harf, renk ve ölçüleri değiştir. Önizleme gerçek zamanlı
              güncellensin.
            </span>
          </div>
          ...
          <div className="designer-facade">
            ...
            >
              ...
              <div className="designer-board-content">
                {logo && (
                  <img src={logo} alt="" className="designer-logo-preview" />
                )}
